...
namespace SimpleFabric.Actors.Runtime
{
    public abstract class ActorBase
    {
        ...
        protected virtual Task OnActivateAsync() { throw new NotImplementedException(); }
        //
        // Summary:
        ...
        protected virtual Task OnDeactivateAsync() { throw new NotImplementedException(); }
        //
        // Summary:
        ...
        protected virtual Task OnPostActorMethodAsync(ActorMethodContext actorMethodContext) { throw new NotImplementedException(); }
        //
        // Summary:
        ...
        //     method when a client request comes. Invoking a method on Microsoft.ServiceFabric.Actors.Runtime.IRemindable
        //     interface when a reminder fires. Invoking a timer callback when timer fires.
        protected virtual Task OnPreActorMethodAsync(ActorMethodContext actorMethodContext) { throw new NotImplementedException(); }
        //
        // Summary:
